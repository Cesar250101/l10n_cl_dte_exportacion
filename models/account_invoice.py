...
class Exportacion(models.Model):
    ...
    def _id_doc(self, taxInclude=False, MntExe=0):
        ...
        res = super(Exportacion, self)._id_doc(taxInclude)
    ...
    def _transporte(self):
        ...
        if expo.carrier_id:
            ...
            try:
                ...
                Transporte['Chofer'] = {}
                Transporte['RUTTrans'] = self.format_vat(self.company_id.vat)
                Transporte['Chofer']['RUTChofer'] = '12258231-0'
                Transporte['Chofer']['NombreChofer'] = 'Cesar'
    ...
    def _encabezado(self, MntExe=0, no_product=False, taxInclude=False):
        ...
        res = super(Exportacion, self)._encabezado(MntExe)
        if not self._es_exportacion():
            return res
